    ...
    <section className="w-full min-h-screen flex justify-center items-center text-purple-100 bg-purple-600 p-8 md:p-16">
      <div className="max-w-5xl w-full mx-auto flex flex-col justify-center items-center gap-8 py-12 md:py-20">
        ...
        >
          ...
          Medan dengan konsep idola yang bisa bertemu langsung dengan penggema,
          mirip dengan AKB48. MDN48 memiliki beberapa tim, seperti Team M, Team
          D, dan Team N, serta memiliki sistem trainee untuk anggota yang sedang
          dalam masa pelatihan sebelum debut resmi.
        </p>
        <p
          data-aos="fade-right"
          data-aos-once
